<?php
	if(!$bool){
?>
<div class="modal fade" id="delete_sub_kategori<?php echo $id_sub_kategori?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		...
		<div class="modal-header">
			...
			<div class="modal-body">
				Apa Kamu yakin akan menghapus sub kategori?
			</div>
...
<?php
	...
	if(ISSET($_POST['delete'])){
		...
		$conn->query("delete from sub_kategori where id_sub_kategori='$id_sub_kategori'") or die(mysql_error());
